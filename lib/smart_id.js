...
SmartId.prototype.certificate = function(id, opts) {
	return this.request("certificatechoice/etsi/" + encode(id), {
		method: "POST",
		json: opts
...
SmartId.prototype.authenticate = function(id, signableHash, opts) {
	return this.request("authentication/etsi/" + encode(id), {
		method: "POST",
		json: _.assign({
		...
		new SmartIdSession("authentication", res.body.sessionID, function(obj) {
			if (obj.state != "COMPLETE") return null
...
// https://github.com/SK-EID/smart-id-documentation/blob/master/README.md#612-computing-the-verification-code
