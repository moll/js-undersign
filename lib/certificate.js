...
_.defineGetter(Certificate.prototype, "serialNumber", function() {
	return this.asn.tbsCertificate.serialNumber
})

_.defineGetter(Certificate.prototype, "subject", function() {
	return serializeSubject(this.asn.tbsCertificate.subject)
})

_.defineGetter(Certificate.prototype, "subjectDer", function() {
	return X509Asn.Name.encode(this.asn.tbsCertificate.subject)
})

_.defineGetter(Certificate.prototype, "validFrom", function() {
	return parseTime(this.asn.tbsCertificate.validity.notBefore)
})

_.defineGetter(Certificate.prototype, "validUntil", function() {
	return parseTime(this.asn.tbsCertificate.validity.notAfter)
})

_.defineGetter(Certificate.prototype, "subjectDistinguishedName", function() {
	return serializeDistinguishedName(this.asn.tbsCertificate.subject)
})

_.defineGetter(Certificate.prototype, "subjectRfc4514Name", function() {
	return serializeRfc4514Name(this.asn.tbsCertificate.subject)
})

_.defineGetter(Certificate.prototype, "publicKey", function() {
	return this.asn.tbsCertificate.subjectPublicKeyInfo.subjectPublicKey.data
})

_.defineGetter(Certificate.prototype, "publicKeyAlgorithm", function() {
	var oid = this.asn.tbsCertificate.subjectPublicKeyInfo.algorithm.algorithm
	return oid.join(".")
})

_.defineGetter(Certificate.prototype, "publicKeyAlgorithmName", function() {
	return X509Asn.CRYPTO_NAMES[this.publicKeyAlgorithm]
})

_.defineGetter(Certificate.prototype, "publicKeyParameters", function() {
...
_.defineGetter(Certificate.prototype, "issuer", function() {
	return serializeSubject(this.asn.tbsCertificate.issuer)
})

_.defineGetter(Certificate.prototype, "issuerDer", function() {
	return X509Asn.Name.encode(this.asn.tbsCertificate.issuer)
})

_.defineGetter(Certificate.prototype, "issuerDistinguishedName", function() {
	return serializeDistinguishedName(this.asn.tbsCertificate.issuer)
})

_.defineGetter(Certificate.prototype, "issuerRfc4514Name", function() {
	return serializeRfc4514Name(this.asn.tbsCertificate.issuer)
})

_.defineGetter(Certificate.prototype, "issuerSignatureAlgorithm", function() {
	return this.asn.signatureAlgorithm.algorithm.join(".")
})

_.defineGetter(Certificate.prototype, "issuerSignatureAlgorithmName",
	function() {
	return X509Asn.SIGNATURE_NAMES[this.issuerSignatureAlgorithm]
})

_.defineGetter(Certificate.prototype, "ocspUrl", function() {
